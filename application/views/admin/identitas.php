                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('admin/identitas'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat Apotek..." value="<?= $identitas['alamat']; ?>" required>
                                <?= form_error('alamat', '<small class="text-danger pl-1">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="noTelp">No. Telepon</label>
                                <input type="text" class="form-control" id="noTelp" name="noTelp" placeholder="Nomor Telepon Apotek..." value="<?= $identitas['no_telp']; ?>" required>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <?php if ($identitas['icon'] != 'hand-holding-usd') : ?>
                                    <form action="<?= base_url('admin/identitas'); ?>" method="post" class="mb-2 text-center">
